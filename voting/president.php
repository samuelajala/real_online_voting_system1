...
<form action="" method="post" class="form-group">
  ...
  <p class="list-group-item">
    <input type="submit" name="president" value="VOTE" onclick="return confirm();" class="btn btn-success">
  </p>
</form>
...
$checkid = "SELECT * FROM president WHERE voter_id='$id'";
...
if(mysqli_num_rows($check_exist) >=  1){
  ...
  $voted_id = "INSERT INTO president (voter_id) VALUES('$id')";
  ...
  echo "<div class='alert alert-success'>You have voted successfully</div>";
	...
	$can_view = "SELECT * FROM candidates WHERE Position ='president'";
