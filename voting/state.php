...
<form action="" method="post" class="form-group">
  ...
  <p class="list-group-item">
    <input type="submit" name="state" value="VOTE" onclick="return confirm();" class="btn btn-success">
  </p>
</form>
...
$checkid = "SELECT * FROM state_assembly WHERE voter_id='$id'";
...
if(mysqli_num_rows($check_exist) >= 1){
  ...
  $voted_id = "INSERT INTO state_assembly (voter_id) VALUES('$id')";
  ...
  echo "<div class='alert alert-success'>You have voted successfully</div>";
	...
	$can_view = "SELECT * FROM candidates WHERE Position ='state assembly'";
